let
    ...
    #"Filtered Rows" = Table.SelectRows(#"Removed Other Columns", each Text.Contains([lrn], "YOUR_LRN_PREFIX")),
    ...
    #"Extracted LRN" = Table.TransformColumns(#"Changed Type", {
        {"lrn", each Text.BetweenDelimiters(_, ".", "."), type text}
    }),
